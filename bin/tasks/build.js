...
OrangeeJSBuildTask.prototype._build_lg = function() {
  ...
  OrangeeJSUtil.concat_js(src, OrangeeJSUtil.core_js_sources.concat("/platforms/orangee.lg.js"), "build/lg/WebContent/orangee.min.js");
...
OrangeeJSBuildTask.prototype._build_cordova = function(os_name, resizes, icon_map, splash_map, appdata) {
  ...
  OrangeeJSUtil.resize_image(resizes, function() {
    ...
    OrangeeJSUtil.concat_js(src, OrangeeJSUtil.core_js_sources.concat("/platforms/orangee.html5.js"), 'build/' + os_name + '/www/orangee.min.js');
...
OrangeeJSBuildTask.prototype._build_samsung = function() {
  ...
  OrangeeJSUtil.concat_js(src, OrangeeJSUtil.core_js_sources.concat("/platforms/orangee.samsung.js"), "build/samsung/orangee.min.js");
